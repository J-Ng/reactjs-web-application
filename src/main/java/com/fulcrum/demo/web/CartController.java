...
//	method = RequestMethod.GET,  
//	produces = "application/json")
//  public List<Product> getCartItems(@SessionAttribute(Constants.ID_SESSION_SHOPPING_CART) List<Product> shoppingCart) {
//    return shoppingCart;
//  }
//	
//	/**
...
//	public String addItem(@RequestBody ItemRequest request, @SessionAttribute(Constants.ID_SESSION_SHOPPING_CART) List<Product> shoppingCart) {
...
//			consumes = "application/json")
//	public String deleteItem(@RequestBody ItemRequest request, @SessionAttribute(Constants.ID_SESSION_SHOPPING_CART) List<Product> shoppingCart) {
//		Optional<Product> optional = getProductById(products.stream(), request.getId());
//		
//		if (optional.isPresent()) {
//			Product product = optional.get();
...
//		model.addAttribute(Constants.ID_SESSION_SHOPPING_CART, new ArrayList<Product>());
